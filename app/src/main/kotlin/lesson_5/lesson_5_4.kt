...
fun main() {
    ...
    println("[монотонно] Ну что ж, пользователь \"$username\", " +
            "теперь введите свой пароль... если вам не лень, конечно...")
    ...
    if (password == correctPassword) {
        ...
        println("[устало] Неверный пароль... Как и следовало ожидать. " +
                "[вздыхает] Попробуйте ещё раз... если вам действительно это нужно...")
    }
